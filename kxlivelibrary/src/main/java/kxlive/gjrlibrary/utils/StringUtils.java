...
*/
	...
	/**
	 * Object基类转化为long型, 排除空字符，null和NULL转换异常
	 * @param obj
	 * @return
	 */
	public static long obj2Long(Object obj){
		if(obj==null || isNull(obj.toString()) 
		  || obj.toString().equals("null") || obj.toString().equals("NULL")){
			return 0l;
		}
	...
	/**
	 * Object基类转化为long型，含默认值, 排除空字符，null和NULL转换异常
	 * @param obj
	 * @return
	 */
	...
	/**
	 * 将Object基类转化为int型, 排除空字符，null和NULL转换异常
	 * @param obj
	 * @return
	 */
	 ...
	 * @return
	 */
	public static int obj2Int(Object obj, int def){
		if(obj==null || isNull(obj.toString()) 
				  || obj.toString().equals("null") || obj.toString().equals("NULL")){
			return def;
		}
	...
	/**
	 * 将object基类类型转化为double型, 排除空字符，null和NULL转换异常
	 * @param obj
	 * @return
	 */
